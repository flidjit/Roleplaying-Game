from proto_refactor import *
from toolkit_refactor import InputHandler, MobHandler
from panda3d.core import NodePath, OrthographicLens, TextureStage
...
class ThePlayer:
    def __init__(self, aoa_window=None):
        ...
        self.is_gm = False
        self.my_character = 'Character Name'
        self.pc_party = {}
        self.cooldowns = {}
